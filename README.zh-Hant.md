...
**預部署實例：`xget.me`** - 僅適合評估與試用，正式環境或對可用性敏感的場景建議自行部署。
...
| Go 模組          | `golang`    | `https://proxy.golang.org/...`                                      | `https://xget.me/golang/...`                                               |
...
| Jenkins 外掛程式 | `jenkins`   | `https://updates.jenkins.io/...`                                    | `https://xget.me/jenkins/...`                                              |
...
| Google 容器註冊表    | `gcr`          | `https://gcr.io/...`                        | `https://xget.me/cr/gcr/...`          |
| Microsoft 容器註冊表 | `mcr`          | `https://mcr.microsoft.com/...`             | `https://xget.me/cr/mcr/...`          |
| Amazon Public ECR    | `ecr`          | `https://public.ecr.aws/...`                | `https://xget.me/cr/ecr/...`          |
| GitHub 容器註冊表    | `ghcr`         | `https://ghcr.io/...`                       | `https://xget.me/cr/ghcr/...`         |
| GitLab 容器註冊表    | `gitlab`       | `https://registry.gitlab.com/...`           | `https://xget.me/cr/gitlab/...`       |
| Red Hat 註冊表       | `redhat`       | `https://registry.redhat.io/...`            | `https://xget.me/cr/redhat/...`       |
| Oracle 容器註冊表    | `oracle`       | `https://container-registry.oracle.com/...` | `https://xget.me/cr/oracle/...`       |
| Cloudsmith           | `cloudsmith`   | `https://docker.cloudsmith.io/...`          | `https://xget.me/cr/cloudsmith/...`   |
| DigitalOcean 註冊表  | `digitalocean` | `https://registry.digitalocean.com/...`     | `https://xget.me/cr/digitalocean/...` |
| VMware 註冊表        | `vmware`       | `https://projects.registry.vmware.com/...`  | `https://xget.me/cr/vmware/...`       |
| Kubernetes 註冊表    | `k8s`          | `https://registry.k8s.io/...`               | `https://xget.me/cr/k8s/...`          |
| Heroku 註冊表        | `heroku`       | `https://registry.heroku.com/...`           | `https://xget.me/cr/heroku/...`       |
| SUSE 註冊表          | `suse`         | `https://registry.suse.com/...`             | `https://xget.me/cr/suse/...`         |
| openSUSE 註冊表      | `opensuse`     | `https://registry.opensuse.org/...`         | `https://xget.me/cr/opensuse/...`     |
| Gitpod 註冊表        | `gitpod`       | `https://registry.gitpod.io/...`            | `https://xget.me/cr/gitpod/...`       |
...
# 新增遠端儲存庫
git remote add upstream https://xget.me/gh/[擁有者]/[儲存庫].git

# 拉取更新
git pull https://xget.me/gh/microsoft/vscode.git main

# 子模組遞迴克隆
git clone --recursive https://xget.me/gh/[使用者名稱]/[帶子模組的儲存庫].git
```
...
# 應用程式引用描述檔
https://xget.me/flathub/repo/appstream/[應用程式 ID].flatpakref
...
2. 點擊 **+** 後輸入儲存庫 URL：`https://xget.me/fdroid/repo`
3. 點擊**新增**後再點擊**新增鏡像**
...
```url
# F-Droid 應用程式 APK 下載
https://xget.me/fdroid/repo/[軟體包名]_[版本號].apk

# F-Droid 儲存庫索引
https://xget.me/fdroid/repo/index-v1.jar

# F-Droid 應用程式圖示
https://xget.me/fdroid/repo/icons-640/[軟體包名].[版本號].png

# F-Droid API 介面
https://xget.me/fdroid/api/v1/packages/[軟體包名]
```
...
# Jenkins 外掛程式下載
https://xget.me/jenkins/download/plugins/[外掛程式名]/[版本]/[外掛程式名].hpi
